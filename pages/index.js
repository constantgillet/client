...
const SectionIntroBackground = styled.div`
  ...
  &::before {
    ...
    height: 100%;
    top: 0px;
    background: linear-gradient(0deg , rgba(16, 35, 58, 0.67), rgba(16, 35, 58, 0.67)), url(/images/backgrounds/background-index.jpg);
          ...
          <Row>
            ...
            <SeachAnnonceCol md={6}>
              ...
              <SearchBox>
                ...
                <SearchBoxSelect instanceId="categorySelect" options={categoriesOptions} placeholder="Catégorie" />
                <SearchBoxSelect instanceId="regionSelect" options={options} placeholder="Catégorie" />
                <Button icon={ faSearch } block>Rechercher</Button>
              </SearchBox>
