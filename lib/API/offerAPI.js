...
const OfferAPI = class {
  ...
  getAllOffer = (params) => {
    ...
    customParams.append("query", params.query);
    customParams.append("order_by", params.orderBy);
    customParams.append("category", params.category);
    customParams.append("department", params.department);
    customParams.append("limit", params.limit);
    customParams.append("user_id", params.userId);
    customParams.append("page", params.page);
